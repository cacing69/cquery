  ...
  <body>
    <span id="lorem">
      <div class="link valid">
        ...
        <a class="ini vip class-1" data-attr="" href="http://ini-url-1.com">Href Attribute Example 1
          <p>Lorem pilsum</p>
        </a>
      </div>
      <div class="link">
        <h1 id="title-id-2" class="class-title-1">Title 2</h1>
        <a class="vip class-2 nih" data-attr="" href="http://ini-url-2.com">Href Attribute Example 2</a>
      </div>
      <div class="link">
        <h1 id="title-id-3" class="class-title-1">Title 3</h1>
        <a class="premium class-3" data-attr="" href="http://ini-url-3.com">Href Attribute Example 4</a>
      </div>
      <div class="link">
        <h1>Title 11</h1>
        <a class="vip class-1" data-attr="" href="http://ini-url-11.com">Href Attribute Example 78</a>
        </div>
      <div class="link">
        <h1>Title 22</h1>
        <a class="itu class-2 vip" data-attr="" href="http://ini-url-22.com">Href Attribute Example 90</a>
      </div>
      <div class="link">
        <h1>Title 323</h1>
        <a class="premium class-3" data-attr="" href="http://ini-url-33-1.com">Href Attribute Example 5</a>
      </div>
      <div class="link pending">
        <h1>Title 331</h1>
        <a class="premium class-31" data-attr="" href="http://ini-url-33-2.com">Href Attribute Example 51</a>
      </div>
      <div class="link pending">
        <h1>Title 339</h1>
        <a class="premium class-32" data-attr="" href="http://ini-url-33-0.com">Href Attribute Example 52</a>
      </div>
    </span>
    <p>
